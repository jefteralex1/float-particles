// Solicite ao usuário o número de partículas
var userInput = prompt("Digite o número de partículas desejado:");

// Verifique se o usuário clicou em "Cancelar" ou deixou o campo em branco
if (userInput === null || userInput.trim() === "") {
  // Se o usuário não digitou nada ou deixou em branco, defina o valor padrão para 6000
  var numberOfParticles = 6000;
} else {
//Converte a entrada do usuário em um número
  var numberOfParticles = parseInt(userInput);

//Verifica se a entrada é um número válido
  if (isNaN(numberOfParticles)) {
    alert("Você não inseriu um número válido. O valor padrão será usado.");
    // Se a entrada não for um número válido, defina o valor padrão para 6000
    numberOfParticles = 6000;
  }
}
//Use a variável numberOfParticles conforme necessário em seu código
alert("Número de partículas atualizado para: " + numberOfParticles);
